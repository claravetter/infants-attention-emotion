...
write.csv(df_all, "/Users/claravetter/Desktop/BabylabanalysenNEW/SRO_O1_Model.csv")

df_all <- read.csv("/Users/claravetter/Desktop/BabylabanalysenNEW/SRO_O1_Model.csv", header = T)
...
write.csv(df3,"/Users/claravetter/Desktop/BabylabanalysenNEW/WithNA_SRO_O1_Model.csv")
...
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit.csv")

CI<-intervals(fit, which = "fixed")
write.csv(data.frame(CI$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit_CI.csv")
...
output <- summary(fit0)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit0.csv")

CI0<-intervals(fit, which = "fixed")
write.csv(data.frame(CI0$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit0_CI.csv")

#############

sum(!is.na(ndf$father.anxiety))/length(ndf$father.anxiety) # 58.33% not missing
sum(!is.na(ndf$mother.anxiety))/length(ndf$mother.anxiety) # 91.67% not missing
sum(!is.na(ndf$MeanInfantTemp))/length(ndf$MeanInfantTemp) # 91.67% not missing
...
output <- summary(fit1)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit1.csv")


CI1<-intervals(fit1, which = "fixed")
write.csv(data.frame(CI1$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit1_CI.csv")
...
output <- summary(fit2)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit2.csv")


CI2<-intervals(fit2, which = "fixed")
write.csv(data.frame(CI2$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit2_CI.csv")

# interactions anx and infant temp
fit3 <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + BaseTime + TrialID  + mother.anxiety*ModelEmo + mother.anxiety*MeanInfantTemp, 
            random = ~ 1 + BaseTime | Subject/TrialID, 
            method = "ML", correlation = corAR1(form = ~ BaseTime | Subject/TrialID),
            data = ndf, na.action = na.exclude)
summary(fit3)
...
output <- summary(fit3)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit3.csv")


CI3<-intervals(fit3, which = "fixed")
write.csv(data.frame(CI3$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fit3_CI.csv")
...
fitfinal <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + BaseTime + TrialID  + MeanInfantTemp + ModelEmo*mother.anxiety, #+ MeanInfantTemp*ModelEmo,
            random = ~ 1 + BaseTime | Subject/TrialID,
            method = "ML", correlation = corAR1(form = ~ BaseTime | Subject/TrialID),
            data = ndf, na.action = na.exclude)
summary(fitfinal)
...
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fitfinal.csv")


CIfinal<-intervals(fitfinal, which = "fixed")
write.csv(data.frame(CIfinal$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O1_Model_fitfinal_CI.csv")
...
output <- summary(fit4)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit.csv")


CI4<-intervals(fit4, which = "fixed")
write.csv(data.frame(CI4$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit_CI.csv")
...
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit0.csv")

CI0ex<-intervals(fit1ex, which = "fixed")
write.csv(data.frame(CI0ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit0_CI.csv")
...
fit1ex <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + BaseTime + TrialID +  mother.anxiety  + MeanInfantTemp, 
              ...
              data = ndfex, na.action = na.exclude)
summary(fit1ex)
anova(fit1ex,fitfinalex)
rsq.lmm(fit1ex, adj = T, type = )

output <- summary(fit1ex)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit1.csv")

CI1ex<-intervals(fit1ex, which = "fixed")
write.csv(data.frame(CI1ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit1_CI.csv")

fit2ex <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + BaseTime + TrialID + mother.anxiety*ModelEmo  + ModelEmo*MeanInfantTemp, 
              random = ~ 1 + BaseTime | Subject/TrialID, 
              method = "ML", correlation = corAR1(form = ~ BaseTime | Subject/TrialID),
              data = ndfex, na.action = na.exclude)
summary(fit2ex)
...
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit2.csv")


CI2ex<-intervals(fit2ex, which = "fixed")
write.csv(data.frame(CI2ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit2_CI.csv")
...
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit3.csv")

CI3ex<-intervals(fit3ex, which = "fixed")
write.csv(data.frame(CI3ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O1_Model_fit3_CI.csv")
