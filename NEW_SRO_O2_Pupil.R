...
df_all <- read.csv(csv_files[2], header = T)
...
write.csv(df_all, "/Users/claravetter/Desktop/BabylabanalysenNEW/SRO_O2_Model.csv")

df_all <- read.csv("/Users/claravetter/Desktop/BabylabanalysenNEW/SRO_O2_Model.csv", header = T)

tr <- vector()
for (i in 1:length(unique(df_all$Subject))){
  tr <- append(tr,length(unique(df_all$TrialID[df_all$Subject==unique(df_all$Subject)[i]])))
}
mean(tr) # on average, infants contributed with 9.27 trials
sd(tr) # 4.20
range(tr) # 4, 15
...
n <- length(unique(df_all$Subject)) # 11
...
write.csv(df3,"/Users/claravetter/Desktop/BabylabanalysenNEW/WithNA_SRO_O2_Model.csv")
...
skewness(df3$MeanInfantTemp,na.rm=T)
kurtosis(df3$MeanInfantTemp,na.rm=T) 
skewness(df3$mother.anxiety,na.rm=T)
kurtosis(df3$mother.anxiety,na.rm=T)
qqplot(resid(fit),)
...
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit.csv")

CI<-intervals(fit, which = "fixed")
write.csv(data.frame(CI$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit_CI.csv")
...
output <- summary(fit0)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit0.csv")

CI0<-intervals(fit0, which = "fixed")
write.csv(data.frame(CI0$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit0_CI.csv")

#############

sum(!is.na(df3$father.anxiety))/length(df3$father.anxiety) # 63.64% not missing
sum(!is.na(df3$mother.anxiety))/length(df3$mother.anxiety) # 100% not missing
sum(!is.na(df3$MeanInfantTemp))/length(df3$MeanInfantTemp) # 100% not missing
...
output <- summary(fit1)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit1.csv")


CI1<-intervals(fit1, which = "fixed")
write.csv(data.frame(CI1$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit1_CI.csv")
...
output <- summary(fit2)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit2.csv")




CI2<-intervals(fit2, which = "fixed")
write.csv(data.frame(CI2$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit2_CI.csv")

# interactions anx and infant temp
fit3 <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + ModelObjRelation + BaseTime + TrialID + ModelEmo*mother.anxiety + MeanInfantTemp*ModelEmo + mother.anxiety*MeanInfantTemp, 
            random = ~ 1 + BaseTime | Subject/TrialID, 
            method = "ML", correlation = corAR1(form = ~ BaseTime | Subject/TrialID),
            data = df3, na.action = na.exclude)
summary(fit3)
...
output <- summary(fit3)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit3.csv")


CI3<-intervals(fit3, which = "fixed")
write.csv(data.frame(CI3$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fit3_CI.csv")

# final 
fitfinal <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + ModelObjRelation + BaseTime + TrialID + MeanInfantTemp + ModelEmo*mother.anxiety,# + MeanInfantTemp*ModelEmo, 
            random = ~ 1 + BaseTime | Subject/TrialID, 
            method = "ML", correlation = corAR1(form = ~ BaseTime | Subject/TrialID),
            data = df3, na.action = na.exclude)
summary(fitfinal)
...
dev.copy(png,'/Users/claravetter/Desktop/BabylabanalysenNEW/Plots/SRO2_Resid_fit_fitfinal.png')
dev.off()

output <- summary(fitfinal)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fitfinal.csv")


CIfinal<-intervals(fitfinal, which = "fixed")
write.csv(data.frame(CIfinal$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/SRO_O2_Model_fitfinal_CI.csv")


anova(fit,fit0)
anova(fit1,fit2,fit3,fitfinal)
##############
#### exploratory 
...
output <- summary(fit4)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit.csv")


CI4<-intervals(fit4, which = "fixed")
write.csv(data.frame(CI4$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit_CI.csv")
...
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit0.csv")

CI0ex<-intervals(fit0ex, which = "fixed")
write.csv(data.frame(CI0ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit0_CI.csv")
...
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit1.csv")


CI1ex<-intervals(fit1ex, which = "fixed")
write.csv(data.frame(CI1ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit1_CI.csv")


fit2ex <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + ModelObjRelation + BaseTime + TrialID +   ModelEmo*mother.anxiety + MeanInfantTemp*ModelEmo, 
              random = ~ 1 + BaseTime | Subject/TrialID, 
              method = "ML", correlation = corAR1(form = ~ BaseTime | Subject/TrialID),
              data = df3ex, na.action = na.exclude)
summary(fit2ex)
...
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit2.csv")


CI2ex<-intervals(fit2ex, which = "fixed")
write.csv(data.frame(CI2ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit2_CI.csv")

# interactions anx and infant temp
fit3ex <- lme(fixed = AverageDiameterPupils ~ 1+ ModelEmo + BaseTime + ModelObjRelation + TrialID  + mother.anxiety*MeanInfantTemp, 
              random = ~ 1 + BaseTime | Subject/TrialID, 
              method = "ML", correlation = corAR1(form = ~ BaseTime | Subject/TrialID),
              data = df3ex, na.action = na.exclude)
summary(fit3ex)
plot(resid(fit3ex))
dev.copy(png,'/Users/claravetter/Desktop/BabylabanalysenNEW/Plots/SRO2_Resid_exfit_fit3.png')
dev.off()


output <- summary(fit3ex)
output <- as.data.frame(output$tTable)
write.csv(output,"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit3.csv")


CI3ex<-intervals(fit3ex, which = "fixed")
write.csv(data.frame(CI3ex$fixed),"/Users/claravetter/Desktop/BabylabanalysenNEW/Output/HAPPY_SRO_O2_Model_fit3_CI.csv")

anova(fit4,fit0ex)
anova(fit1ex,fit2ex,fit3ex)
